  ...
  return (
    <div className={styles.todo_panel_container}>
      <div className={styles.fields_container}>
        <div className={styles.field_container}>
          <label htmlFor="name">
            <div>Todo Name</div>
            <input
              data-testid={isEdit ? 'edit_todo_name' : 'add_todo_name'}
              type="text"
        ...
        <div className={styles.field_container}>
          <label htmlFor="description">
            ...
            <input
              type="text"
              data-testid={isEdit ? 'edit_todo_desc' : 'add_todo_desc'}
              placeholder="Merry Xmas"
              id="description"
      ...
      <div className={styles.button_container}>
        {!isEdit && (
          <Button color="white" onClick={onClick} data-testid="add_todo_button">
            Add new task
          </Button>
        )}
        {isEdit && (
